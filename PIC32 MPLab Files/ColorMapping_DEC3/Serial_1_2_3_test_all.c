...
#define MAX_BLUE_ch1 2250
#define MIN_BLUE_ch1 1800
#define MAX_BLUE_ch2 260
...
static PT_THREAD (protothread_param(struct pt *pt))
{
    ...
    tft_fillRoundRect(30, 200, 80, 80, 1, ILI9340_BLACK);// x,y,w,h,radius,color
    while (strcmp(fruit, banana) && strcmp(fruit, orange) && strcmp(fruit, avocado))
    {      
        tft_setTextColor(ILI9340_RED); tft_setTextSize(1.5);
        tft_fillRoundRect(30, (210 + (setting * 10)), 80, 10, 1, ILI9340_WHITE);// x,y,w,h,radius,color
...
//                
	...
	while (1) {
        ...
        //Clear Corresponding Section of the TFT Display
        tft_fillRoundRect(30, 200, 320, 80, 1, ILI9340_BLACK);// x,y,w,h,radius,color
        tft_setCursor(30, 200);
        sprintf(buffer, "State: %d, Color_reading: %d, Curx: %d, Cury: %d", state, color_reading, cursor_x, cursor_y);
        tft_writeString(buffer);
        tft_setCursor(30, 210);
        ...
        switch (state) {
            ...
            case 4: // continue moving right; start drawing pixels
                ...
                tft_fillRect(cursor_x, cursor_y, 8, 8, color_reading);
                cursor_x+=incr;
            ...
            case 7:
                ...
                tft_fillRoundRect(30, 200, 320, 42, 1, ILI9340_BLACK);// x,y,w,h,radius,color
                while (!reset)
                {
                    //Clear Corresponding Section of the TFT Display
                    tft_setCursor(30, 200);
                ...
                {  
                    tft_setTextColor(ILI9340_YELLOW); tft_setTextSize(1.5);
                    tft_fillRoundRect(30, (210 + (setting * 10)), 320, 10, 1, ILI9340_WHITE);// x,y,w,h,radius,color
                    tft_setCursor(30, 200);
                    sprintf(buffer, "Which fruit to detect ripeness?");
                    tft_writeString(buffer);
                    tft_setCursor(30, 210);
