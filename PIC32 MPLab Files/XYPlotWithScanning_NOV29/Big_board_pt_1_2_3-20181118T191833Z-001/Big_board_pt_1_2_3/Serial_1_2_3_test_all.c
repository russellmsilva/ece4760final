...
//TODO: User Interface Thread to enter fruit type
	...
	while (1) {
        ...
        switch (state) {
            ...
            case 4: // continue moving right; start drawing pixels
                ...
                tft_setCursor(cursor_x, cursor_y);
                //tft_fillRoundRect(cursor_x, cursor_y, 10, 10, 1, magic color from magic formula)
                cursor_x+=incr;
            ...
            case 6: // move down
                ...
                else if (total_steps_down = max_down && (final direction matches)){
                    state = 7;
                }        
                break;
